...
```
Total ad / tracking block list 屏蔽追踪广告总数: 89629

Total allowlist list 允许名单总数: 9975

Total combine list 结合总数： 89226
