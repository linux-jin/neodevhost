...
```
Total ad / tracking block list 屏蔽追踪广告总数: 84193

Total allowlist list 允许名单总数: 9976

Total combine list 结合总数： 83788
