...
```
Total ad / tracking block list 屏蔽追踪广告总数: 100683

Total allowlist list 允许名单总数: 9977

Total combine list 结合总数： 100278
