...
```
Total ad / tracking block list 屏蔽追踪广告总数: 173226

Total allowlist list 允许名单总数: 9780

Total combine list 结合总数： 172827
