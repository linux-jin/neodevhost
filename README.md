...
```
Total ad / tracking block list 屏蔽追踪广告总数: 128593

Total allowlist list 允许名单总数: 9968

Total combine list 结合总数： 128190
