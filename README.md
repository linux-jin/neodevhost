...
```
Total ad / tracking block list 屏蔽追踪广告总数: 226049

Total allowlist list 允许名单总数: 9973

Total combine list 结合总数： 225646
