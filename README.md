...
```
Total ad / tracking block list 屏蔽追踪广告总数: 133652

Total allowlist list 允许名单总数: 9971

Total combine list 结合总数： 133249
