...
```
Total ad / tracking block list 屏蔽追踪广告总数: 136987

Total allowlist list 允许名单总数: 9972

Total combine list 结合总数： 136584
