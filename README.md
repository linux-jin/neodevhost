...
```
Total ad / tracking block list 屏蔽追踪广告总数: 132493

Total allowlist list 允许名单总数: 9969

Total combine list 结合总数： 132090
