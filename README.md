...
```
Total ad / tracking block list 屏蔽追踪广告总数: 126497

Total allowlist list 允许名单总数: 9959

Total combine list 结合总数： 126094
